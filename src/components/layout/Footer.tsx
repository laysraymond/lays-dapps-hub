...
export function Footer() {
  return (
    <footer className="border-t border-border-dark bg-bg-dark mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            {links.map((l) => (
              <a
                ...
                className="flex items-center gap-1.5 text-sm text-text-secondary-dark hover:text-text-primary-dark transition-colors"
              >
                <l.Icon />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm text-text-secondary-dark hover:text-text-primary-dark transition-colors group"
          >
            <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden border border-border-dark group-hover:border-primary/40 transition-colors shrink-0">
              <Image src="/creator-avatar.jpg" alt="Lays" fill sizes="40px" className="object-cover" />
            </div>
